...
const Shop = () => {
  ...
  const products = [
    ...
    },
    {
      ...
      price: "KSh 200/ea",
      imageUrl: "https://lh3.googleusercontent.com/aida-public/AB6AXuDFy6CObgFjdoPOrbucVVZ_zMZ1WvJrkDtPDkoD931RUYRIpR6lz7Z1QBlmIpsGovpT3cHnbSUiq4ZvXjfPMuce6ALaN8UYGS46Hv1aRPceDYWn-P7irLI9aJ0c-J54urWawoyi67v6lBcgPZxYHqqsz3LQamKUyzDsoYrj4kzKPcn_X0qXeK5rla-u1P_YoF6i7Aiu_uey4f_6aaVXj_sbp4xSvh4bxpL8UxjG-k06jHICy4k2W2p6Xe5lonQMQu5qos1GwI4eUaba",
      category: "fruits",
      inStock: false,
      rating: 4.7,
      reviewCount: 93,
    ...
    },
    {
      ...
      price: "KSh 150/bunch",
      imageUrl: "https://images.unsplash.com/photo-1540420773420-3366772f4999?w=500&h=400&fit=crop",
      category: "vegetables",
      inStock: true,
      rating: 4.3,
      reviewCount: 78,
  ...
  const categories = [
    ...
    { id: 'nuts', name: 'Nuts & Seeds', count: products.filter(p => p.category === 'nuts').length }
  ];
          ...
          <div className="d-flex flex-wrap gap-2 justify-content-center">
            {categories.map((category) => (
              <button
                ...
                className={`btn text-capitalize ${selectedCategory === category.id 
                  ? 'btn-success' 
                  : 'btn-outline-success'}`}
                style={{
                  borderRadius: '25px',
